...
# top10のみ
mkdir -p ../../experiments/nbow.${CORPUS}_h40000.$MODEL.trgtrg_top10/topk/
DIR=../../data/${CORPUS}.$MODEL.NBoW/trgtrg_top100/
python 03.NeuralBoW.py  -train_in4nbow  $DIR/${CORPUS}_train_h40000.in4nbow \
                        ...
                        -corpus_name ${CORPUS} \
                        -output_dir ../../experiments/nbow.${CORPUS}_h40000.$MODEL.trgtrg_top10 \
                        -only_predict True \
                        -topk_of_sim 100
...
# SSS + ED (with_matchのみ)
# target-target
# top10:[[34958, 347, 5816], [323, 3751, 574], [5069, 484, 970187]]
# top100:[[231788, 1772, 43640], [1316, 14064, 2527], [43097, 3328, 9490891]]
